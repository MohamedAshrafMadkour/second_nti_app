...
class CustomSelectTimeItem extends StatelessWidget {
  const CustomSelectTimeItem({super.key});
        ...
        child: Row(
          children: [
            SizedBox(
              ...
              child: Image.asset(AppImages.imagesTest11, fit: BoxFit.cover),
            ),
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      SvgPicture.asset(AppIcons.iconsUnFavIcon, height: 15),
                    ],
                  ),
